...
const Hero = () => {
	...
	return (
		<section className={hero_style.hero}>
			...
			<iframe
				src='https://www.youtube.com/embed/rNDuqSPdLw0?autoplay=1&amp;loop=1&amp;enablejsapi=1&amp;&amp;playerapiid=featuredytplayer&amp;controls=0&amp;modestbranding=1&amp;rel=0&amp;showinfo=0&amp;color=white&amp;iv_load_policy=3&amp;theme=light&amp;wmode=transparent&amp;playlist=A_SjnjcfVeI&amp;mute=1'
				frameBorder='0'
				allow='autoplay'
